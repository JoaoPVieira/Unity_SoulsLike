        ...
        public void HandleLockOn()
        {
            ...
            for (int i = 0; i < colliders.Length; i++)
            {
                ...
                if (character != null)
                {
                    ...
                    {
                        Debug.Log("Added Potential Target");
                        if (Physics.Linecast(playerManager.lockOnTransform.position, character.lockOnTransform.position, out hit))
                        {
                            ...
                            {
                                //Cannot lock onto target, object on the way
                            }
                            else
                            {
            ...
            if (availableTargets.Count > 0)
            {
                for (int k = 0; k < availableTargets.Count; k++)
                {
                    ...
                    {
                        Debug.Log("Updated Closest Enemy");
                    ...
                    {
                        Vector3 relativePlayerPosition = currentLockOnTarget.InverseTransformPoint(availableTargets[k].transform.position);
                        ...
                        {
                            Debug.Log("Updated Closest to the Right");
                            shortestDistanceOfRightTarget = distanceFromRightTarget;
                            rightLockTarget = availableTargets[k].lockOnTransform;
                        }*/
                    }
